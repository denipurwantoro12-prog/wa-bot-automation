...
module.exports = {
  ...
  saveScheduledBroadcast: (draft, prompt, numbers, time) => {
    return db.prepare('INSERT INTO scheduled_broadcasts (draft, prompt, numbers, scheduled_time) VALUES (?, ?, ?, ?)').run(draft, prompt, numbers, time);
  },
